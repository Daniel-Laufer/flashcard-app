...
const middleware = require("../middleware.js");
 ...
 // documentation available at <base_url>/api/api-docs/
 router.get("/flashcard_collections/:collectionId", middleware.authorize, async (req, res) => {
    await standardGetRouteActions(addresses["rest-api-server"], `flashcard_collections/${req.params.collectionId}`, req, res, req.authorization_details);
});
 ...
 // documentation available at <base_url>/api/api-docs/
 router.put("/flashcard_collections/:collectionId/rating", middleware.authorize,async (req, res) => {
    // deconstructing the request body
    ...
    await standardPutRouteActions(addresses["rest-api-server"], `flashcard_collections/${req.params.collectionId}/rating`, payload, req, res);
});
